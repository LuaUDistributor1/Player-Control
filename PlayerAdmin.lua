-- LocalScript: Put this in StarterGui or StarterPack
-- GUI Setup (Local Script)
...
-- Command descriptions (updated - removed fling/dance)
local commands = {
...
-- Command parser (removed fling/dance commands)
